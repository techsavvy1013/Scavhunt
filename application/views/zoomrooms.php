...
<div class="content-wrapper">
    ...
    <section class="content" id="section_content">
        ...
        <div id="divZoomRooms" class="tabcontent">
        <div class="row"><!--   -->
        ...
        <div id="divScavrHunts" class="tabcontent">
        <div class="row"><!--   -->
            <div class="col-md-12 col-xs-12" id="huntsDiv" style="overflow-x:auto;overflow-y:scroll;">
                <table class="table table-striped table-bordered table-sm table-responsive table-hover" id="myTable2">
                    <thead>
                    <tr>
                        <th>No</th>
                        <th>School</th>
                    ...
                    <tbody>
                    <?php
                    if(!empty($judgeTeamInfos))
                    {
                        $i =1;
                        foreach($judgeTeamInfos as $record)
                        {
                    ?>
                    <tr class="table-row">
                        <td><?php echo $i; ?></td>
                        <td><?php echo $record["schoolname"]; ?></td>
                        <td><?php echo $record["teamname"] . " -> " . $record["teamsize"]; ?></td>
                        <td><?php echo $record["samedevice"]; ?></td>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function(){
        ...
        $(window).scroll(function () {
            ...
            var eltab = $('#roomTabbar');
            var eltabpos = eltab.offset().top;
            var eltabheight = eltab.height();
            ...
            {
                finaldestination = windowpos - originalelpos - eltabpos - eltabheight;
            }
        ...
        openRoomTab(event, "divZoomRooms");
    });
    ...
    function openRoomTab(evt, divTabName)
    {
